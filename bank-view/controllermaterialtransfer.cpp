...
void ControllerMaterialTransfer::onInsert()
{
    ...
    __record.setGenerated(QVariant::fromValue(SlotBlock::ID).toString(),false); //id would be autogenerated
    __record.setGenerated(QVariant::fromValue(SlotBlock::DATA_0).toString(),false);
