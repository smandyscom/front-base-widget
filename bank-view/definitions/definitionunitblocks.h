...
public:
    ...
    enum TransitionBits
    {
        ...
        BIT_1_TEMP_CONDITION_1 = 0x010000 + OFFSET_MONITOR_TRANSITION_WORD,
        BIT_2_TEMP_CONDITION_2 = 0x020000 + OFFSET_MONITOR_TRANSITION_WORD,
        BIT_3_TEMP_CONDITION_3 = 0x030000 + OFFSET_MONITOR_TRANSITION_WORD,
        BIT_4_TEMP_CONDITION_4 = 0x040000 + OFFSET_MONITOR_TRANSITION_WORD,
        BIT_5_TEMP_CONDITION_5 = 0x050000 + OFFSET_MONITOR_TRANSITION_WORD,
        BIT_6_TEMP_CONDITION_6 = 0x060000 + OFFSET_MONITOR_TRANSITION_WORD,
        BIT_7_TEMP_CONDITION_7 = 0x070000 + OFFSET_MONITOR_TRANSITION_WORD,
        BIT_8_TEMP_CONDITION_8 = 0x080000 + OFFSET_MONITOR_TRANSITION_WORD,
    };
